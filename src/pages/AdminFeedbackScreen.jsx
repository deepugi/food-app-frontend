...
const Tr = (props) => {
    ...
    const agentRatings = store.getState().delivery.deliveryratings;
    const  restaurantRatings = store.getState().restaurant.restaurantRatings;
    ...
    return (
        <tr>
            ...
            (agentrating === 5 ? 'Responding Fast and doing great' : 'He is going good')
            }</td>
            <td className="text-center">{      
            (restaurantrating === 5 ? 'Tastes awesome' : 'Avg taste')
            }</td>
            <Toast ref={toast}></Toast>
        </tr>
    );
